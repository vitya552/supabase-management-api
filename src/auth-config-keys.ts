// Generated from packages/api-types/types/platform.d.ts (GoTrueConfigResponse).
// Regenerate with scripts listed in the README when the platform API types change.
