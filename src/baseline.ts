...
/**
 * Baseline auth configuration mirrored from the same env vars that
 * docker-compose passes to the auth container, so the dashboard reflects
 * the stack's static configuration before any runtime overrides exist.
 */
